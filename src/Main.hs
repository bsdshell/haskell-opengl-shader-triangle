...
-- https://hackage.haskell.org/package/OpenGLRaw-1.1.0.0/docs/Graphics-Rendering-OpenGL-Raw-Core31.html
...
--    GLFW.windowHint (GLFW.WindowHint'Resizable False)
    ...
    -- From $HOME/myfile/bitbucket/stackproject/Haskell-OpenGL-Tutorial-Mandelbrot/app
    GLFW.windowHint (GLFW.WindowHint'ContextVersionMajor 3)
